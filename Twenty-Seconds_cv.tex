...
\aboutme{
Systems Engineer, with extensive knowledge and experience in Software Engineering and Software Development for enterprise applications. Honest, fun to work with, self-managed, problem solver, high self-learning and leadership skills. Interests in quality practices, design and software architecture.}%About me section

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%Skill bar section, each skill must have a value between 0 an 6 (float)%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\skills{{Design Patterns/4},{Linux/5},{Persistent/4.3},{OOP/4},{Java/5.61},{TDD/4}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%Skill text section, each skill must have a value between 0 an 6%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\skillstext{{openly expresses ideas/4},{negotiates, resolves differences/3},{PSP Developer/4}}
...
%%%%%%%%%%%%%%%%%%%%
\section{interests}
I love to travel the world, meeting new people, hangout with friends; sometimes i play the guitar
...
\twentyitem
    ...
    {PSL}
    {Build software components as a Back End developer in the AWS Platform with the Spring Framework. Built software for an advertising company}
\twentyitem
    {2016 - 2018}
